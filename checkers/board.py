import pygame
from .constants import BLACK, ROWS, SQUARE_SIZE, COLS, WHITE, GREY, BROWN
...
class Board:
    ...
    def move(self, piece, row, col):
        self.board[piece.row][piece.col], self.board[row][col] = self.board[row][col], self.board[piece.row][piece.col] #this is swapping
        piece.move(row, col)
